...
from rl_games.algos_torch.models import ModelA2CMultiDiscrete, ModelA2CContinuousLogStd
    ...
    class Network(ModelA2CContinuousLogStd.Network):
        ...
        def forward(self, input_dict):
            ...
            if (is_train):
                ...
                amp_obs_demo = input_dict['amp_obs_demo']
                disc_demo_logit = self.a2c_network.eval_disc(amp_obs_demo)
                result['disc_demo_logit'] = disc_demo_logit

            return result


class ModelAMPMultiDiscrete(ModelA2CMultiDiscrete):
    def __init__(self, network):
        super().__init__(network)
    ...
    def build(self, config):
        ...
        for name, _ in net.named_parameters():
            print(name)
        return ModelAMPMultiDiscrete.Network(net)

    class Network(ModelA2CMultiDiscrete.Network):
        def __init__(self, a2c_network, ):
            super().__init__(a2c_network)
            return
